    ...
    <div class="row justify-content-center">
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card border-secondary mb-3">
               <b> <div class="card-header bg-secondary text-center">Light bulbs</div></b>
                ...
                <div class="card-body text-secondary bg-secondary text-center">
                   <a href="..\consumer\devices\lightbulb.php"> <button class="btn btn-primary">Click to manage</button></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card border-secondary mb-3">
               <b> <div class="card-header bg-secondary text-center">Thermostat</div></b>
                <img class="card-img-top" src="..\img\thermostat.jpg" alt="Card image cap">
                <div class="card-body text-secondary bg-secondary text-center">
                <a href="..\consumer\devices\thermostat.php"> <button class="btn btn-primary">Click to manage</button></a>                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card border-secondary mb-3">
              <b>  <div class="card-header bg-secondary text-center">Smart Locks</div></b>
                <img class="card-img-top" src="..\img\smartlock.jpg" alt="Card image cap">
                <div class="card-body text-secondary bg-secondary text-center">
                <a href="..\consumer\devices\smartlock.php"> <button class="btn btn-primary">Click to manage</button></a>                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card border-secondary mb-3">
             <b>   <div class="card-header bg-secondary text-center">Security Cameras</div></b>
                <img class="card-img-top" src="..\img\security.jpeg" alt="Card image cap">
                <div class="card-body text-secondary bg-secondary text-center">
                <a href="..\consumer\devices\camera.php"> <button class="btn btn-primary">Click to manage</button></a>                </div>
            </div>
        </div>
    </div>
</section>
