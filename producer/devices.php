      ...
      <div>
        <nav class="navbar">
          ...
          <form class="d-flex mr-lg-3" role="search">
            <input
              class="form-control me-2 mr-lg-2"
              type="search"
              placeholder="Search"
              aria-label="Search"
            />
            <button class="btn btn-outline-light mr-lg-4" type="submit">
              Search
            </button>
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="card">
            ...
            <ul style="height: 100px;" class="list-group list-group-flush">
              <?php
                // Veritabanı bağlantısı
                $servername = "localhost"; // Veritabanı sunucusunun adı veya IP adresi
                $username = "root"; // Veritabanı kullanıcı adı
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM termostat WHERE name = 'Kitchen thermostat' LIMIT 1";
                $result = $conn->query($sql);
        
                if ($result->num_rows > 0 ) {
                  while ($row = $result->fetch_assoc()) {
                    if($row['status']=='ON'){
                      echo "<li id='status' class='list-group-item'><h3>". $row['name'] . ' is ' . $row['status']   . "</h3></li>";
                    }
              ...
              <?php
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM termostat WHERE name = 'Living room thermostat
                ' LIMIT 1";
                $result = $conn->query($sql);
              ...
              <?php
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM termostat WHERE name = 'Bedroom thermostat' LIMIT 1";
                $result = $conn->query($sql);
              ...
              <?php
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM termostat WHERE name = 'Bathroom thermostat' LIMIT 1";
                $result = $conn->query($sql);
          ...
          <div class="card"style="width:270px">
            ...
            <ul class="list-group list-group-flush">
              <?php
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM locks WHERE lock_name = 'exteriorLock' LIMIT 1";
                $result = $conn->query($sql);
        
                if ($result->num_rows > 0 ) {
                  while ($row = $result->fetch_assoc()) {
                    if($row['status']=='ON'){
                      echo "<li id='status' class='list-group-item'><h3>". $row['lock_name'] . ' is ' . $row['status']   . "</h3></li>";
                    }
              ...
              <?php
                ...
                // Veri almak için sorgu
                $sql = "SELECT * FROM locks WHERE lock_name = 'garageLock' LIMIT 1";
                $result = $conn->query($sql);
