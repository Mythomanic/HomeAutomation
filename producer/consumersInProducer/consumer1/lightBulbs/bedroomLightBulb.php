...
<div>
    <nav class="navbar">
        <a style="font-size: xx-large;" class="navbar-brand text-light">Bedroom Light of Consumer 1</a>
          ...
          <script>
            new Chart(document.getElementById("line-chart"), {
              ...
              'Friday','Saturday','Sunday'],
                datasets : [
                    {
                      data : [ 1386, 205, 1321, 1516, 2107,
                          2191, 1133, 1221, 1783, 1478 ],
                      label : "Consumption",
                      borderColor : "#3cba9f",
                      fill : true
                    }]
      ...
      <div class="col-md-5 ml-4">
        <div class="card text-center" style="height:100%;">
          <div class="card-header">
            <strong style="size: 50px;">Bedroom Lightbulb</strong>
          </div>
          <div class="card-body">
