...
<!-- /#sidebar-wrappers -->
    ...
    <div>
      <nav class="navbar">
          <a style="font-size: xx-large;" class="navbar-brand text-light">Kitchen Heater of Consumer 1</a>
      ...
      <div class="col-md-5 ml-4">
        <div class="card text-center" style="height:100%;">
          <div class="card-header">
            <strong style="size: 50px;">Kitchen Heater</strong>
          </div>
          <div class="card-body">
          ...
          <div class="card">
            <ul class="list-group list-group-flush">
              <?php
                ...
                $sql = "SELECT * FROM termostat WHERE id = 1 LIMIT 1";
