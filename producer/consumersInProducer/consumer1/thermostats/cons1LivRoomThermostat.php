...
<!-- /#sidebar-wrappers -->
    ...
    <div>
      <nav class="navbar">
          <a style="font-size: xx-large;" class="navbar-brand text-light">Livingroom Heater of Consumer 1</a>
          ...
          <div class="card">
            <ul class="list-group list-group-flush">
              <?php
                ...
                $sql = "SELECT * FROM termostat WHERE id = 2 LIMIT 1";
